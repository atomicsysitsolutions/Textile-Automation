        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExportMarket = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfiles_Vendor_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeaveType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaterialComposition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cost = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MinimumOrder = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplyReviews", x => x.ReplyreviewId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@gmail.com", "Admin", "Kj/SHQl/5VdGjzMhAYHMCg==:y8PfvFtoP0B76TqwWF9r5iQ7t41xZ6D2BtOeOM3sBNM=", "Admin" });

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_VendorId",
